...
- If the user needs to refresh the active personal CV, use `local/personal-overlay.yml` plus `npm run personal:sync` instead of hand-editing the main resume files.
