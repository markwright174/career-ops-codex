...
- Texas State Technical College: measurable delivery, completion, faculty, or learner outcomes from the programs and PBE transition.
- Lone Star College: campus size, learner volume in D2L, and any adoption, satisfaction, or teaching-practice outcomes from faculty training.
- UTeach Computer Science: clearer evidence of usability, engagement, or platform-improvement gains after the Codio migration and accessibility audit.
- Texas Southern University: total certification completions and any reduction in support burden or friction after the UI redesign.
- NASA Johnson Space Center: whether the multimedia content supported one program or multiple programs, plus any measurable engagement or program outcomes.
- Alight Education Services: any additional operational gains or measurable service improvements beyond growth and satisfaction.
